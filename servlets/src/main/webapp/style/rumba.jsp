...
<body>
    <h1>
        <fmt:message key="prop.style.rumba.title" bundle="${resourceBundle}"/>
    </h1>
    <h2>
        <fmt:message key="prop.style.rumba.history" bundle="${resourceBundle}"/>
    </h2>
    <fmt:message key="prop.style.rumba.text1" bundle="${resourceBundle}"/>
    <h2>
        <fmt:message key="prop.style.rumba.features" bundle="${resourceBundle}"/>
    </h2>
