...
<h1><fmt:message key="prop.style.electro.title" bundle="${resourceBundle}"/></h1>

<h2><fmt:message key="prop.style.electro.history" bundle="${resourceBundle}"/></h2>
<fmt:message key="prop.style.electro.text1" bundle="${resourceBundle}"/>


<h2><fmt:message key="prop.style.electro.etimology" bundle="${resourceBundle}"/></h2>
<fmt:message key="prop.style.electro.text2" bundle="${resourceBundle}"/>

<h2><fmt:message key="prop.style.electro.characteristic" bundle="${resourceBundle}"/></h2>
