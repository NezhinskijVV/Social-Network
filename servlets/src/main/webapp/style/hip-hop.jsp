...
<body>
    <h1>
        <fmt:message key="prop.style.hiphop.title" bundle="${resourceBundle}"/>
    </h1>
    <fmt:message key="prop.style.hiphop.text1" bundle="${resourceBundle}"/>
    <h2>
        <fmt:message key="prop.style.hiphop.oldschool" bundle="${resourceBundle}"/>
    </h2>
    <h3>
        <fmt:message key="prop.style.hiphop.buddha" bundle="${resourceBundle}"/>
    </h3>
    <fmt:message key="prop.style.hiphop.text2" bundle="${resourceBundle}"/>
    <br>
    <h3>
        <fmt:message key="prop.style.hiphop.henry" bundle="${resourceBundle}"/>
    </h3>
    ...
    <ul>
        <li> <fmt:message key="prop.style.hiphop.oldmoves.smurf" bundle="${resourceBundle}"/></li>
    ...
    <br>
    <h2>
        <fmt:message key="prop.style.hiphop.middleschool" bundle="${resourceBundle}"/>
    </h2>
    <h3>
        <fmt:message key="prop.style.hiphop.buddha" bundle="${resourceBundle}"/>
    </h3>
    ...
    <br>
    <fmt:message key="prop.style.hiphop.middlemoves" bundle="${resourceBundle}"/>
    <ul>
        <li> <fmt:message key="prop.style.hiphop.middlemoves.partymachine" bundle="${resourceBundle}"/></li>
    ...
    <br>
    <h2>
        <fmt:message key="prop.style.hiphop.newschool" bundle="${resourceBundle}"/>
    </h2>
    <h3>
        <fmt:message key="prop.style.hiphop.buddha" bundle="${resourceBundle}"/>
    </h3>
    ...
    <br>
    <fmt:message key="prop.style.hiphop.newschoolmoves" bundle="${resourceBundle}"/>
    <ul>
