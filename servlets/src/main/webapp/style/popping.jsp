...
<h1><fmt:message key="prop.style.popping.title" bundle="${resourceBundle}"/></h1>

<fmt:message key="prop.style.popping.text1" bundle="${resourceBundle}"/>
<h2><fmt:message key="prop.style.popping.history" bundle="${resourceBundle}"/></h2>
...
<h2><fmt:message key="prop.style.popping.popularity" bundle="${resourceBundle}"/></h2>

<fmt:message key="prop.style.popping.text4" bundle="${resourceBundle}"/>
<h2><fmt:message key="prop.style.popping.falling" bundle="${resourceBundle}"/></h2>

<fmt:message key="prop.style.popping.text5" bundle="${resourceBundle}"/>

<h2><fmt:message key="prop.style.popping.rebirth" bundle="${resourceBundle}"/></h2>
